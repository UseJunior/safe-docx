...
source MUST belong to the same cell, and deletion MUST leave at least one
paragraph in that cell. The compiler SHALL continue to reject operations that
...
- **GIVEN** canonical Markdoc requests deletion of a cell's sole paragraph or uses a formatting source from another cell
