...
- [x] 3.3 Add CI MCPB bundle phase (`npm run pack:mcpb -w @usejunior/safedocx-mcpb`) and upload `safe-docx.mcpb` on main builds.
...
- [x] 4.5 `npm run test:run -w @usejunior/docx-comparison`
- [x] 4.6 `npm run test:run -w @usejunior/docx-primitives`
- [x] 4.7 `npm run test:run -w @usejunior/safedocx`
- [x] 4.8 `npm run test:run -w @usejunior/safedocx-mcpb`
- [x] 4.9 `npm run check:spec-coverage -w @usejunior/safedocx`
- [x] 4.10 `npm run pack:mcpb -w @usejunior/safedocx-mcpb`
