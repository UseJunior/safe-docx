...
The initial proposal was not implementation approval and held PR #980. Owner approved the shared merge scope September 14, the field-aware extension September 15, and the bounded #984 section-mark blocker extension September 17. The decision table and field conflict were adjudicated before implementation/shipping; PR #980 merged September 16 after exact-head Opus review and full local/corpus/schema gates, followed by exact-merge public smoke. See tasks.md and evidence.md for completed evidence and continuing Word limits. A materially wider change still requires renewed owner approval; reader disagreement may not be hidden by weakening native formatting checks.
