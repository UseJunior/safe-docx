...
- Check in the version-stamped generated verdict snapshot with per-case locally recorded Aspose output-XML hashes, and make CI reproduce its deterministic fixture hashes,
