...
- Decision: emit a canonical JSON snapshot rather than checking in Aspose-produced DOCX files. The generated snapshot will
  contain the oracle/version stamp, fixture IDs and hashes, locally recorded Aspose output-XML hashes for drift review, and structural verdicts sufficient to distinguish
