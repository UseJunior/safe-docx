...
- **AND** the self-check SHALL derive expected support independently from the operation descriptor and input package shape rather than production support declarations or scenario identifiers
