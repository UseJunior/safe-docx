...
describe('WmlElement', () => {
  it('can represent a text element', () => {
    const element: WmlElement = el('w:t', {}, undefined, 'Hello World');
  ...
  it('can represent an element with attributes', () => {
    const element: WmlElement = el('w:ins', {
      'w:id': '1',
      'w:author': 'John Doe',
  ...
  it('can represent nested elements', () => {
    ...
    const paragraph: WmlElement = el('w:p', {}, [run]);
  ...
  it('can have parent reference', () => {
    const child: WmlElement = el('w:t', {}, undefined, 'Test');
    const parent: WmlElement = el('w:r', {}, [child]);
