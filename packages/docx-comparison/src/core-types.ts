...
// =============================================================================
// WmlElement Interface
// =============================================================================

/**
 * Abstract representation of an OOXML element.
 *
 * Provides a normalized interface for XML elements from `fast-xml-parser` output.
 * The `parent` property is backfilled during tree traversal for ancestor navigation.
 *
 * @see XElement in System.Xml.Linq
 */
export interface WmlElement {
  /** Element tag name with namespace prefix, e.g., "w:r", "w:t" */
  tagName: string;
  /** Element attributes as key-value pairs */
  attributes: Record<string, string>;
  /** Child elements (optional) */
  children?: WmlElement[];
  /** Text content for leaf nodes (optional) */
  textContent?: string;
  /** Parent element reference (backfilled during tree walking) */
  parent?: WmlElement;
}
 ...
 */
export const DEFAULT_MOVE_DETECTION_SETTINGS: MoveDetectionSettings = {
  detectMoves: true,
 ...
 */
export const DEFAULT_FORMAT_DETECTION_SETTINGS: FormatDetectionSettings = {
 ...
 */
export const RUN_PROPERTY_FRIENDLY_NAMES: Record<string, string> = {
  'w:b': 'bold',
  'w:bCs': 'boldComplex',
  'w:i': 'italic',
  'w:iCs': 'italicComplex',
 ...
 */
export const DEFAULT_COMPARER_SETTINGS: WmlComparerSettings = {
