...
import type { ParagraphInfo, AlignmentResult } from '@usejunior/docx-core';
...
export function alignParagraphs(
  ...
  for (const origPara of unmatchedOriginal) {
    let bestMatch: { para: ParagraphInfo; similarity: number } | null = null;
...
export interface ParagraphClassification {
  ...
  identical: Array<{ original: ParagraphInfo; revised: ParagraphInfo }>;
 ...
 */
export function classifyAlignment(alignment: AlignmentResult): ParagraphClassification {
