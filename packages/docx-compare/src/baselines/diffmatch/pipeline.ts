...
import type { AlignmentResult } from '@usejunior/docx-core';
...
import {
  generateParagraphOperations,
  buildDocumentWithTrackChanges,
 ...
 */
export async function compareDocumentsBaselineB(
  original: Buffer,
  revised: Buffer,
  ...
  const operations = generateParagraphOperations(
    alignment,
    originalParagraphs,
    revisedParagraphs,
    { author, date }
