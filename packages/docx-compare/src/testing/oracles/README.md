...
`aspose-field-oracle.v1.json` is reviewable evidence generated locally with `aspose-words==25.10`; Aspose and
its license are never installed in CI. Microsoft Word remains the primary behavioral oracle.
