...
- Compare two documents to produce a tracked-changes output document (`compare_documents`; redlines are generated by final comparison, not tracked incrementally during edits)
