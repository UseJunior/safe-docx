...
describe('OpenSpec traceability: add-auto-normalization-on-open', () => {
  ...
  test.openspec('jr_para_* IDs stable across normalization')('Scenario: jr_para_* IDs stable across normalization', async () => {
    ...
    await allureStep('Then unchanged paragraphs SHALL receive the same jr_para_* identifiers', async () => {
