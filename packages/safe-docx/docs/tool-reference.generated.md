...
Replace text in a paragraph by jr_para_* id, preserving formatting. Accepts session_id or file_path.
...
Insert a paragraph before/after an anchor paragraph by jr_para_* id. Accepts session_id or file_path.
